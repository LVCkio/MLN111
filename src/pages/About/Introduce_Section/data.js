...
export const concepts = [
  {
    icon: Scale,
    title: "Biện chứng khách quan",
    text: "Sự vận động, liên hệ, mâu thuẫn và phát triển của chính thế giới vật chất, tồn tại độc lập với ý thức con người.",
  },
  {
    icon: Layers,
    title: "Biện chứng chủ quan",
    text: "Sự phản ánh biện chứng khách quan vào tư duy — phép biện chứng duy vật với tư cách là khoa học, phương pháp luận.",
  },
  {
    icon: GitMerge,
    title: "Nguyên lý liên hệ phổ biến",
    text: "Mọi sự vật tồn tại trong mối liên hệ qua lại, quy định, chuyển hóa lẫn nhau. Phải nhìn nhận sự vật toàn diện, tránh phiến diện.",
  },
  {
    icon: RefreshCw,
    title: "Nguyên lý phát triển",
    text: "Phát triển là vận động đi lên, từ thấp đến cao, có kế thừa, diễn ra theo đường xoáy ốc. Nguồn gốc là mâu thuẫn bên trong.",
  },
  {
    icon: Eye,
    title: "Bản chất và Hiện tượng",
    text: "Bản chất là cái ổn định bên trong, hiện tượng là biểu hiện bên ngoài (thường bị cải biến). Phải đi từ hiện tượng vào bản chất.",
  },
  {
    icon: Target,
    title: "Khả năng và Hiện thực",
    text: "Khả năng chuyển hóa thành hiện thực khi có điều kiện. Phải xuất phát từ hiện thực, tích cực tạo điều kiện cho khả năng tốt thành hiện thực.",
  },
];
